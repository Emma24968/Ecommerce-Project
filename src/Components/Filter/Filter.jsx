...
export const Filter = ({products, onFilterCategory,onFilterSize, onClear, selectedCategory, selectedSize}) => {
  return (
  ...
  <Size products={products} selectedSize={selectedSize} onFilter={onFilterSize}/>
